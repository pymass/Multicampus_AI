...
-- test table 생성 (column 생성 - datatype -  DECIMAL(5,3))
create table testtbl(test DECIMAL(5,3));
...
ALTER TABLE testtbl ADD test_f1 float(5,3);

-- 값 입력 - test_fl : 14.55555 / test : 16.55555
insert into testtbl(test, test_f1) values (16.55555,14.55555);

-- test table 삭제
ALTER TABLE testtbl DROP test;
...
create table items(item_id varchar(255) primary key,
item varchar(255),
unit_price numeric(10,2),
company_id varchar(255));
...
create table companies(company_id varchar(255) primary key,
company_name varchar(255),
headquarters_phone_number int(12));
...
select * from employees where first_name='Denis' or 'Elvis';
